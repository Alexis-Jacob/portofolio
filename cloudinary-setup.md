# Cloudinary Setup Prompt

> ⚠️ Ne jamais renseigner l'API Secret ici. Ne jamais committer ce fichier avec le Secret.

## Credentials

- **Cloud Name:** g2vm121o
- **API Key:** 241121858189694
- **API Secret:** `<INSERT_API_SECRET>` ← ne jamais committer

---

## Onboarding Prompt (à coller dans Claude Code)
